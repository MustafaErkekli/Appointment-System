...
namespace eAppointmentServer.Domain.Enums
{
	public sealed class DepartmentEnum : SmartEnum<DepartmentEnum>
	{
		...
		public static readonly DepartmentEnum Hemotoloji = new("Hemotoloji", 9);
		public static readonly DepartmentEnum EnfeksiyonHastalıkları = new("Enfeksiyon Hastalıkları", 10);
